...
инфраструктура для провайдеров моделей, мессенджеров и desktop-релизов.
...
Сборка настроена в workflow `tauri-desktop-release.yml` и проверяет Rust-тесты
перед упаковкой Windows/Linux установщиков.
...
- Проверять Windows/Linux desktop-установщики на чистых машинах перед
  публичными релизами.
