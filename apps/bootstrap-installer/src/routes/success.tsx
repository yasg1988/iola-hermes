  ...
  return (
    <div className="hermes-fade-in flex h-full flex-col items-center justify-center gap-8 px-12 py-10">
      <div className="w-full max-w-2xl min-w-0 text-center">
        ...
        >
          <span>
            <span>Hermes RU Iola готов</span>
          </span>
          <span aria-hidden="true">Hermes RU Iola готов</span>
        </p>
      ...
      >
        <Rocket size={18} />
        {launching ? 'Запуск…' : 'Запустить Hermes'}
      </Button>
      ...
      {error && (
        ...
        >
          ...
          <div className="min-w-0">
            <div className="font-medium">Не удалось запустить desktop-приложение</div>
