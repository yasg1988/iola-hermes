 ...
 *
 * A public install can end up with `origin=git@github.com:yasg1988/iola-hermes.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/yasg1988/iola-hermes.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/yasg1988/iola-hermes'
