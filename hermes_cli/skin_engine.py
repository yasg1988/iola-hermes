...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Hermes RU Iola"        # Banner title, status display
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Hermes RU Iola"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "branding": {
            "agent_name": "Hermes RU Iola",
            "welcome": "Добро пожаловать в Hermes RU Iola! Введите сообщение или /help для команд.",
            "goodbye": "До встречи! ⚕",
            "response_label": " ⚕ Iola ",
            "prompt_symbol": "❯",
