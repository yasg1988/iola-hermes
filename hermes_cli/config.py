...
OPTIONAL_ENV_VARS = {
    ...
    "YANDEX_API_KEY": {
        "description": "Yandex AI Studio API key for YandexGPT",
        "prompt": "Yandex AI Studio API key",
        "url": "https://yandex.cloud/ru/docs/ai-studio/operations/get-api-key",
        "password": True,
        "category": "provider",
    },
    "YANDEXGPT_API_KEY": {
        "description": "Alternative YandexGPT API key variable",
        "prompt": "YandexGPT API key (leave empty if YANDEX_API_KEY is set)",
        "url": "https://yandex.cloud/ru/docs/ai-studio/operations/get-api-key",
        "password": True,
        "category": "provider",
        "advanced": True,
    ...
    "YANDEX_FOLDER_ID": {
        "description": "Yandex Cloud folder ID for YandexGPT model URIs and x-folder-id",
    ...
    "GIGACHAT_AUTH_KEY": {
        "description": "GigaChat authorization key used to obtain an access token (Base64 Client ID:Client Secret)",
        "prompt": "GigaChat authorization key (leave empty to enter Client ID and Client Secret)",
        "url": "https://developers.sber.ru/docs/ru/gigachat/quickstart/ind-using-api",
        "password": True,
        "category": "provider",
    },
    "GIGACHAT_CLIENT_ID": {
        "description": "GigaChat Client ID used to build the authorization key",
        "prompt": "GigaChat Client ID",
        "url": "https://developers.sber.ru/docs/ru/gigachat/quickstart/ind-using-api",
        "password": False,
        "category": "provider",
        "advanced": True,
    ...
    "GIGACHAT_CLIENT_SECRET": {
        "description": "GigaChat Client Secret used to build the authorization key",
        "prompt": "GigaChat Client Secret",
        "url": "https://developers.sber.ru/docs/ru/gigachat/quickstart/ind-using-api",
        "password": True,
        "category": "provider",
        "advanced": True,
    ...
    "GIGACHAT_ACCESS_TOKEN": {
        "description": "Pre-issued GigaChat access token (optional; normally use GIGACHAT_AUTH_KEY)",
        "prompt": "GigaChat access token (optional)",
        "url": "https://developers.sber.ru/docs/ru/gigachat/guides/compatible-openai",
        "password": True,
        "category": "provider",
        "advanced": True,
    },
    "GIGACHAT_SCOPE": {
        "description": "GigaChat OAuth scope",
        "prompt": "GigaChat OAuth scope (leave empty for GIGACHAT_API_PERS)",
        "url": None,
        "password": False,
        "category": "provider",
        "advanced": True,
    ...
    "GIGACHAT_BASE_URL": {
        "description": "GigaChat OpenAI-compatible base URL override",
        "prompt": "GigaChat base URL (leave empty for default)",
        "url": None,
        "password": False,
        "category": "provider",
        "advanced": True,
    ...
    "GIGACHAT_OAUTH_URL": {
        "description": "GigaChat OAuth endpoint override",
        "prompt": "GigaChat OAuth URL (leave empty for default)",
        "url": None,
        "password": False,
        "category": "provider",
        "advanced": True,
