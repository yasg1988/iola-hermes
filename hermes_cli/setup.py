"""
Interactive setup wizard for Hermes RU Iola.
...
_DOCS_BASE = "https://github.com/yasg1988/iola-hermes#readme"
...
def _setup_slack():
    ...
    print()
    print_info("   Full guide: https://github.com/yasg1988/iola-hermes#readme")
    print()
...
def _setup_webhooks():
    ...
    print_info("   https://github.com/yasg1988/iola-hermes#readme")
    print()
...
def run_setup_wizard(args):
    ...
    print(
        color(
            "│          ⚕ Мастер настройки Hermes RU Iola            │", Colors.MAGENTA
        )
    )
    print(
        color(
    ...
    print(
        color(
            "│  Настроим вашу установку Hermes RU Iola.              │", Colors.MAGENTA
        )
    )
    print(
        color(
            "│  Нажмите Ctrl+C в любой момент для выхода.            │", Colors.MAGENTA
        )
    )
    print(
        color(
