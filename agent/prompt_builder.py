...
HERMES_AGENT_HELP_GUIDANCE = (
    ...
    "расширением или диагностикой — используй README и локальные документы "
    "Hermes RU Iola как основной источник истины. Если локальные инструкции "
    "и сведения из исходного upstream расходятся, явно укажи это и объясни "
    "практический вариант для Hermes RU Iola."
)
