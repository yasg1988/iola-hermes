...
const PROVIDER_GROUPS: { prefix: string; name: string; priority: number }[] = [
  ...
  { prefix: "GIGACHAT_", name: "GigaChat", priority: 4 },
  ...
  { prefix: "YANDEX_", name: "YandexGPT", priority: 14 },
  { prefix: "YANDEXGPT_", name: "YandexGPT", priority: 14 },
  { prefix: "XIAOMI_", name: "Xiaomi MiMo", priority: 15 },
];
